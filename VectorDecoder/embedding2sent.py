...
# from VectorDecoder.dataloader import SentenceLoader
################################################################################
...
class decoding():
    def __init__(self,encoder,decoder,
                    loss_mode="ml",decoder_net="conrnn",
                    corpora_field=None,max_original_sent_len=10,device="cpu"):

        self.device = device

        self.encoder = encoder
        self.decoder = decoder
        self.dec_net_type = decoder_net
        self.loss_mode = loss_mode

        self.corpora_field = corpora_field
        self.max_sent_len = max_original_sent_len + 2
