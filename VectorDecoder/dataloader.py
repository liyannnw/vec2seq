...
class TextDataLoader():
    ...
    def __init__(self,data_dir,train_filename,valid_filename,test_filename,batch_size=128,
                  init_token="SOS",eos_token="EOS",pad_token="PAD",fix_length=12,device="cpu"):
        ...
        self.corpora_field = Field(tokenize=self.tokenize_en,fix_length=fix_length,
